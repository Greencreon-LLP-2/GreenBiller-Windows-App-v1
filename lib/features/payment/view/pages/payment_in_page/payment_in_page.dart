...
class PaymentInPage extends StatelessWidget {
  ...
  Widget _buildCustomerDetails() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildInfoRow(Icons.person, 'Customer Name', 'John Doe'),
  ...
  Widget _buildPaymentFields() {
    return Column(
      children: [
        _buildAmountField('Total Due', '₹ 25,450', isReadOnly: true),
        const SizedBox(height: 12),
        _buildAmountField('Amount Received', '₹ 0'),
        const SizedBox(height: 12),
        _buildAmountField('Balance', '₹ 25,450',
