...
static Widget buildLogoSection({
  required dynamic logoImage, // can be File or String (url)
  ...
  if (logoImage is File) {
    imageProvider = FileImage(logoImage);
  } else if (logoImage is String && logoImage.isNotEmpty) {
    imageProvider = NetworkImage(logoImage);
  }
