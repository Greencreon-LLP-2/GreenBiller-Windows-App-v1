...
// import 'package:greenbiller/core/constants/api_constants.dart';
// import 'package:greenbiller/core/constants/colors.dart';
...
//                       _buildField("Mobile", controller.mobileController,
...
//                       _buildField("GST Number", controller.gstController,
//                           icon: Icons.confirmation_number),
//                       _buildField("PAN Number", controller.panController,
//                           icon: Icons.credit_card),
//                       _buildField("VAT Number", controller.vatController,
//                           icon: Icons.receipt_long),
//                       _buildField("Store Website", controller.websiteController,
//                           icon: Icons.web),
//                       _buildField("Bank Details", controller.bankDetailsController,
...
//                       _buildField("State", controller.stateController, icon: Icons.map),
//                       _buildField("Postcode", controller.postcodeController,
...
//                             ? _buildField("Signature", controller.signatureController,
//                                 maxLines: 2, icon: Icons.edit)
//                             : const SizedBox.shrink(),
//                       ),
//                       _buildField("Store Logo", controller.storeLogoController,
//                           icon: Icons.image),
//                     ],
//                     icon: Icons.settings,
//                   ),
...
//                     "System Settings",
//                     [
//                       _buildField("Timezone", controller.timezoneController,
//                           icon: Icons.access_time),
//                       _buildField("Currency", controller.currencyController,
//                           icon: Icons.attach_money),
//                       _buildField("Decimals", controller.decimalsController,
//                           keyboardType: TextInputType.number, icon: Icons.exposure),
//                       _buildField("Decimals for Quantity", controller.decimalsQtyController,
//                           keyboardType: TextInputType.number, icon: Icons.numbers),
//                       _buildField("Language", controller.languageController,
//                           icon: Icons.language),
//                     ],
//                     icon: Icons.language,
//                   ),
...
//                     "Sales Settings",
//                     [
//                       _buildField("Default Account", controller.defaultAccountController,
//                           icon: Icons.account_balance_wallet),
//                       _buildField("Sales Invoice Formats", controller.salesInvoiceFormatController,
//                           icon: Icons.receipt),
//                       _buildField("POS Invoice Formats", controller.posInvoiceFormatController,
