...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AccountModel&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other.data, data)&&(identical(other.status, status) || other.status == status));
}
...
class _AccountModel implements AccountModel {
  const _AccountModel({@JsonKey(name: "message") this.message, @JsonKey(name: "data") final  List<Datum>? data, @JsonKey(name: "status") this.status}): _data = data;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AccountModel&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._data, _data)&&(identical(other.status, status) || other.status == status));
}
...
@JsonKey(name: "id") int? get id;@JsonKey(name: "account_name") String? get accountName;@JsonKey(name: "bank_name") String? get bankName;@JsonKey(name: "account_number") String? get accountNumber;@JsonKey(name: "ifsc_code") String? get ifscCode;@JsonKey(name: "upi_id") String? get upiId;@JsonKey(name: "balance") String? get balance;@JsonKey(name: "user_id") String? get userId;@JsonKey(name: "store_id") String? get storeId;@JsonKey(name: "created_at") DateTime? get createdAt;@JsonKey(name: "updated_at") DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,accountName,bankName,accountNumber,ifscCode,upiId,balance,userId,storeId,createdAt,updatedAt);
...
@useResult
$Res call({
@JsonKey(name: "id") int? id,@JsonKey(name: "account_name") String? accountName,@JsonKey(name: "bank_name") String? bankName,@JsonKey(name: "account_number") String? accountNumber,@JsonKey(name: "ifsc_code") String? ifscCode,@JsonKey(name: "upi_id") String? upiId,@JsonKey(name: "balance") String? balance,@JsonKey(name: "user_id") String? userId,@JsonKey(name: "store_id") String? storeId,@JsonKey(name: "created_at") DateTime? createdAt,@JsonKey(name: "updated_at") DateTime? updatedAt
});
...
/// Create a copy of Datum
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? accountName = freezed,Object? bankName = freezed,Object? accountNumber = freezed,Object? ifscCode = freezed,Object? upiId = freezed,Object? balance = freezed,Object? userId = freezed,Object? storeId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  int? id, @JsonKey(name: "account_name")  String? accountName, @JsonKey(name: "bank_name")  String? bankName, @JsonKey(name: "account_number")  String? accountNumber, @JsonKey(name: "ifsc_code")  String? ifscCode, @JsonKey(name: "upi_id")  String? upiId, @JsonKey(name: "balance")  String? balance, @JsonKey(name: "user_id")  String? userId, @JsonKey(name: "store_id")  String? storeId, @JsonKey(name: "created_at")  DateTime? createdAt, @JsonKey(name: "updated_at")  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Datum() when $default != null:
return $default(_that.id,_that.accountName,_that.bankName,_that.accountNumber,_that.ifscCode,_that.upiId,_that.balance,_that.userId,_that.storeId,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  int? id, @JsonKey(name: "account_name")  String? accountName, @JsonKey(name: "bank_name")  String? bankName, @JsonKey(name: "account_number")  String? accountNumber, @JsonKey(name: "ifsc_code")  String? ifscCode, @JsonKey(name: "upi_id")  String? upiId, @JsonKey(name: "balance")  String? balance, @JsonKey(name: "user_id")  String? userId, @JsonKey(name: "store_id")  String? storeId, @JsonKey(name: "created_at")  DateTime? createdAt, @JsonKey(name: "updated_at")  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Datum():
return $default(_that.id,_that.accountName,_that.bankName,_that.accountNumber,_that.ifscCode,_that.upiId,_that.balance,_that.userId,_that.storeId,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "id")  int? id, @JsonKey(name: "account_name")  String? accountName, @JsonKey(name: "bank_name")  String? bankName, @JsonKey(name: "account_number")  String? accountNumber, @JsonKey(name: "ifsc_code")  String? ifscCode, @JsonKey(name: "upi_id")  String? upiId, @JsonKey(name: "balance")  String? balance, @JsonKey(name: "user_id")  String? userId, @JsonKey(name: "store_id")  String? storeId, @JsonKey(name: "created_at")  DateTime? createdAt, @JsonKey(name: "updated_at")  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Datum() when $default != null:
return $default(_that.id,_that.accountName,_that.bankName,_that.accountNumber,_that.ifscCode,_that.upiId,_that.balance,_that.userId,_that.storeId,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Datum implements Datum {
  const _Datum({@JsonKey(name: "id") this.id, @JsonKey(name: "account_name") this.accountName, @JsonKey(name: "bank_name") this.bankName, @JsonKey(name: "account_number") this.accountNumber, @JsonKey(name: "ifsc_code") this.ifscCode, @JsonKey(name: "upi_id") this.upiId, @JsonKey(name: "balance") this.balance, @JsonKey(name: "user_id") this.userId, @JsonKey(name: "store_id") this.storeId, @JsonKey(name: "created_at") this.createdAt, @JsonKey(name: "updated_at") this.updatedAt});
...
/// Create a copy of Datum
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? accountName = freezed,Object? bankName = freezed,Object? accountNumber = freezed,Object? ifscCode = freezed,Object? upiId = freezed,Object? balance = freezed,Object? userId = freezed,Object? storeId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
  return _then(_Datum(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,accountName: freezed == accountName ? _self.accountName : accountName // ignore: cast_nullable_to_non_nullable
as String?,bankName: freezed == bankName ? _self.bankName : bankName // ignore: cast_nullable_to_non_nullable
