...
class PurchaseReturnViewPage extends GetView<PurchaseManageController> {
        ...
        children: [
          ...
          Container(
            ...
            child: Material(
              ...
              child: InkWell(
                borderRadius: BorderRadius.circular(12),
                onTap: controller.fetchPurchaseReturns,
                child: const Padding(
    ...
    return Scaffold(
                ...
                child: Row(
                  children: [
                    _buildActionButton(
                      ...
                      accentColor,
                      () {
                        controller.fetchPurchaseReturns();
      ...
      body: Obx(
        () => Column(
          children: [
            // Summary Cards
            controller.isLoadingReturns.value
                ? Container(
                    padding: const EdgeInsets.all(20),
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: _buildModernSummaryCard(
                            'Total Returns',
                            controller.purchaseReturns.length.toString(),
                        ...
                        Expanded(
                          child: _buildModernSummaryCard(
                            'Total Amount',
                            '₹${controller.totalReturnAmount.value.toStringAsFixed(2)}',
                        ...
                        Expanded(
                          child: _buildModernSummaryCard(
                            'Total Paid',
                            '₹${controller.totalReturnPaid.value.toStringAsFixed(2)}',
                        ...
                        Expanded(
                          child: _buildModernSummaryCard(
                            'Pending Amount',
                            '₹${controller.pendingReturnAmount.value.toStringAsFixed(2)}',
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              '${controller.purchaseReturns.length} records',
                              style: const TextStyle(
                                color: accentColor,
                                fontWeight: FontWeight.w600,
                                fontSize: 14,
                    ...
                    Expanded(
                      child: controller.isLoadingReturns.value
                          ? const Center(
                              child: CircularProgressIndicator(
                                color: accentColor,
                              ),
                            )
                          : controller.hasErrorReturns.value
                          ? _buildNoInternetView()
                          : controller.purchaseReturns.isEmpty
                          ? _buildEmptyState()
