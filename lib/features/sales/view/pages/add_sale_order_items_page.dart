...
class AddSaleOrderItemsPage extends HookConsumerWidget {
  final String? storeId;
  AddSaleOrderItemsPage({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void saveItem() {
      ...
      final salesOrderItem = SaleOrderModelItem(
      ...
      ref
          .read(selectedSalesOrderItemsProvider.notifier)
          .update((state) => [...state, salesOrderItem]);
      context.pop();
    }
