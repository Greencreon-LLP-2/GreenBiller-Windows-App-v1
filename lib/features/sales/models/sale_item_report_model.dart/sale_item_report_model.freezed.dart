...
$SaleItemReportModelCopyWith<SaleItemReportModel> get copyWith => _$SaleItemReportModelCopyWithImpl<SaleItemReportModel>(this as SaleItemReportModel, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SaleItemReportModel&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other.data, data));
}
...
abstract mixin class $SaleItemReportModelCopyWith<$Res>  {
  factory $SaleItemReportModelCopyWith(SaleItemReportModel value, $Res Function(SaleItemReportModel) _then) = _$SaleItemReportModelCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SaleItemReportModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SaleItemReportModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SaleItemReportModel value)?  $default,){
final _that = this;
switch (_that) {
case _SaleItemReportModel() when $default != null:
return $default(_that);case _:
...
class _SaleItemReportModel implements SaleItemReportModel {
  const _SaleItemReportModel({@JsonKey(name: "message") this.message, @JsonKey(name: "data") final  List<Datum>? data}): _data = data;
  factory _SaleItemReportModel.fromJson(Map<String, dynamic> json) => _$SaleItemReportModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$SaleItemReportModelCopyWith<_SaleItemReportModel> get copyWith => __$SaleItemReportModelCopyWithImpl<_SaleItemReportModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SaleItemReportModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SaleItemReportModel&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._data, _data));
}
...
/// @nodoc
abstract mixin class _$SaleItemReportModelCopyWith<$Res> implements $SaleItemReportModelCopyWith<$Res> {
  factory _$SaleItemReportModelCopyWith(_SaleItemReportModel value, $Res Function(_SaleItemReportModel) _then) = __$SaleItemReportModelCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "message") String? message,@JsonKey(name: "data") List<Datum>? data
});
...
@JsonKey(name: "id") int? get id;@JsonKey(name: "store_name") String? get storeName;@JsonKey(name: "item_name") String? get itemName;@JsonKey(name: "sales_id") String? get salesId;@JsonKey(name: "price_per_unit") String? get pricePerUnit;@JsonKey(name: "sales_qty") String? get salesQty;@JsonKey(name: "discount_amt") String? get discountAmt;@JsonKey(name: "total") double? get total;@JsonKey(name: "sales_date") DateTime? get salesDate;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,storeName,itemName,salesId,pricePerUnit,salesQty,discountAmt,total,salesDate);
...
@useResult
$Res call({
@JsonKey(name: "id") int? id,@JsonKey(name: "store_name") String? storeName,@JsonKey(name: "item_name") String? itemName,@JsonKey(name: "sales_id") String? salesId,@JsonKey(name: "price_per_unit") String? pricePerUnit,@JsonKey(name: "sales_qty") String? salesQty,@JsonKey(name: "discount_amt") String? discountAmt,@JsonKey(name: "total") double? total,@JsonKey(name: "sales_date") DateTime? salesDate
});
...
/// Create a copy of Datum
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? storeName = freezed,Object? itemName = freezed,Object? salesId = freezed,Object? pricePerUnit = freezed,Object? salesQty = freezed,Object? discountAmt = freezed,Object? total = freezed,Object? salesDate = freezed,}) {
  return _then(_self.copyWith(
...
as String?,salesQty: freezed == salesQty ? _self.salesQty : salesQty // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  int? id, @JsonKey(name: "store_name")  String? storeName, @JsonKey(name: "item_name")  String? itemName, @JsonKey(name: "sales_id")  String? salesId, @JsonKey(name: "price_per_unit")  String? pricePerUnit, @JsonKey(name: "sales_qty")  String? salesQty, @JsonKey(name: "discount_amt")  String? discountAmt, @JsonKey(name: "total")  double? total, @JsonKey(name: "sales_date")  DateTime? salesDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Datum() when $default != null:
return $default(_that.id,_that.storeName,_that.itemName,_that.salesId,_that.pricePerUnit,_that.salesQty,_that.discountAmt,_that.total,_that.salesDate);case _:
  return orElse();
...
class _Datum implements Datum {
  const _Datum({@JsonKey(name: "id") this.id, @JsonKey(name: "store_name") this.storeName, @JsonKey(name: "item_name") this.itemName, @JsonKey(name: "sales_id") this.salesId, @JsonKey(name: "price_per_unit") this.pricePerUnit, @JsonKey(name: "sales_qty") this.salesQty, @JsonKey(name: "discount_amt") this.discountAmt, @JsonKey(name: "total") this.total, @JsonKey(name: "sales_date") this.salesDate});
...
@override@JsonKey(name: "sales_qty") final  String? salesQty;
...
/// Create a copy of Datum
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? storeName = freezed,Object? itemName = freezed,Object? salesId = freezed,Object? pricePerUnit = freezed,Object? salesQty = freezed,Object? discountAmt = freezed,Object? total = freezed,Object? salesDate = freezed,}) {
  return _then(_Datum(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,storeName: freezed == storeName ? _self.storeName : storeName // ignore: cast_nullable_to_non_nullable
as String?,itemName: freezed == itemName ? _self.itemName : itemName // ignore: cast_nullable_to_non_nullable
