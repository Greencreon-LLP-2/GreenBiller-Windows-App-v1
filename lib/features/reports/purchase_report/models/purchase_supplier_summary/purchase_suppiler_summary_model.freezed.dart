...
$PurchaseSummaryBySupplierModelCopyWith<PurchaseSummaryBySupplierModel> get copyWith => _$PurchaseSummaryBySupplierModelCopyWithImpl<PurchaseSummaryBySupplierModel>(this as PurchaseSummaryBySupplierModel, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PurchaseSummaryBySupplierModel&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other.data, data)&&(identical(other.status, status) || other.status == status));
}
...
abstract mixin class $PurchaseSummaryBySupplierModelCopyWith<$Res>  {
  factory $PurchaseSummaryBySupplierModelCopyWith(PurchaseSummaryBySupplierModel value, $Res Function(PurchaseSummaryBySupplierModel) _then) = _$PurchaseSummaryBySupplierModelCopyWithImpl;
@useResult
$Res call({
...
extension PurchaseSummaryBySupplierModelPatterns on PurchaseSummaryBySupplierModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PurchaseSummaryBySupplierModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PurchaseSummaryBySupplierModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PurchaseSummaryBySupplierModel value)?  $default,){
final _that = this;
switch (_that) {
case _PurchaseSummaryBySupplierModel() when $default != null:
return $default(_that);case _:
...
class _PurchaseSummaryBySupplierModel implements PurchaseSummaryBySupplierModel {
  const _PurchaseSummaryBySupplierModel({@JsonKey(name: "message") this.message, @JsonKey(name: "data") final  List<Datum>? data, @JsonKey(name: "status") this.status}): _data = data;
  factory _PurchaseSummaryBySupplierModel.fromJson(Map<String, dynamic> json) => _$PurchaseSummaryBySupplierModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$PurchaseSummaryBySupplierModelCopyWith<_PurchaseSummaryBySupplierModel> get copyWith => __$PurchaseSummaryBySupplierModelCopyWithImpl<_PurchaseSummaryBySupplierModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PurchaseSummaryBySupplierModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PurchaseSummaryBySupplierModel&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._data, _data)&&(identical(other.status, status) || other.status == status));
}
...
/// @nodoc
abstract mixin class _$PurchaseSummaryBySupplierModelCopyWith<$Res> implements $PurchaseSummaryBySupplierModelCopyWith<$Res> {
  factory _$PurchaseSummaryBySupplierModelCopyWith(_PurchaseSummaryBySupplierModel value, $Res Function(_PurchaseSummaryBySupplierModel) _then) = __$PurchaseSummaryBySupplierModelCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "message") String? message,@JsonKey(name: "data") List<Datum>? data,@JsonKey(name: "status") int? status
});
