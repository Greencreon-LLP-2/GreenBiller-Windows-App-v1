...
part 'purchase_suppiler_summary_model.freezed.dart';
part 'purchase_suppiler_summary_model.g.dart';

@freezed
abstract class PurchaseSummaryBySupplierModel
    with _$PurchaseSummaryBySupplierModel {
  const factory PurchaseSummaryBySupplierModel({
    @JsonKey(name: "message") String? message,
    @JsonKey(name: "data") List<Datum>? data,
    @JsonKey(name: "status") int? status,
  }) = _PurchaseSummaryBySupplierModel;
