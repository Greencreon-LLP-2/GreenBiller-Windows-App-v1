...
mixin _$SalesSummaryCustomerModel {
  ...
  $SalesSummaryCustomerModelCopyWith<SalesSummaryCustomerModel> get copyWith =>
      _$SalesSummaryCustomerModelCopyWithImpl<SalesSummaryCustomerModel>(
          this as SalesSummaryCustomerModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SalesSummaryCustomerModel &&
...
abstract mixin class $SalesSummaryCustomerModelCopyWith<$Res> {
  factory $SalesSummaryCustomerModelCopyWith(SalesSummaryCustomerModel value,
          $Res Function(SalesSummaryCustomerModel) _then) =
      _$SalesSummaryCustomerModelCopyWithImpl;
  @useResult
  $Res call(
...
extension SalesSummaryCustomerModelPatterns on SalesSummaryCustomerModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SalesSummaryCustomerModel value)? $default, {
...
class _SalesSummaryCustomerModel implements SalesSummaryCustomerModel {
  const _SalesSummaryCustomerModel(
      {@JsonKey(name: "message") this.message,
      @JsonKey(name: "data") final List<Datum>? data})
      : _data = data;
  factory _SalesSummaryCustomerModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SalesSummaryCustomerModelCopyWith<_SalesSummaryCustomerModel>
      get copyWith =>
          __$SalesSummaryCustomerModelCopyWithImpl<_SalesSummaryCustomerModel>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SalesSummaryCustomerModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SalesSummaryCustomerModel &&
            (identical(other.message, message) || other.message == message) &&
...
/// @nodoc
abstract mixin class _$SalesSummaryCustomerModelCopyWith<$Res>
    implements $SalesSummaryCustomerModelCopyWith<$Res> {
  factory _$SalesSummaryCustomerModelCopyWith(_SalesSummaryCustomerModel value,
          $Res Function(_SalesSummaryCustomerModel) _then) =
      __$SalesSummaryCustomerModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "message") String? message,
...
mixin _$Datum {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.salesCode, salesCode) &&
  ...
  int get hashCode => Object.hash(
      ...
      customerId,
      customerName,
      const DeepCollectionEquality().hash(salesCode),
      referenceNo,
      grandTotal,
      paidAmount,
      balance,
