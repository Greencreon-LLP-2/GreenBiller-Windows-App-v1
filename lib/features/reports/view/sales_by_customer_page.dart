...
class SalesByCustomerPage extends GetView<SalesByCustomerController> {
  ...
  Widget _buildTableRow(SingleSalesSummaryCustomerItem data) {
    return MouseRegion(
            ...
            onChanged: (value) {
              ...
              if (controller.selectedStoreId.value != null) {
                controller.loadCustomers(
                  controller.selectedStoreId.value.toString(),
                );
              }
            },
          ),
      ...
      child: Obx(
        () => DropdownButtonHideUnderline(
          child: DropdownButton<String>(
            ...
            isExpanded: true,
            icon: controller.isLoadingCustomers.value
                ? const SizedBox(
                    width: 20,
                    height: 20,
                    child: CircularProgressIndicator(
            ...
            items: [
              ...
              ...controller.customerMap.entries.map(
                (entry) => DropdownMenuItem<String>(
                  value: entry.key,
                  child: Text(
                    entry.key,
            ...
            onChanged: (value) {
              ...
              controller.selectedCustomerId.value = value != null
                  ? controller.customerMap[value]
                  : null;
            },
          ),
        ),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        GestureDetector(
                          onTap: () => controller.generateReport(context),
                          child: Container(
                            padding: const EdgeInsets.symmetric(
                              horizontal: 18,
                              vertical: 12,
                    ...
                    Row(
                      children: [
                        Expanded(child: _buildStoreDropdown(context)),
                        const SizedBox(width: 16),
                      ...
                      Expanded(
                        child: Obx(() {
                          ...
                          if (controller.salesSummary.value == null ||
                            ...
                            return const Center(
                              child: Text(
                                'Select date range, store, customer, and generate report to view results',
                                style: TextStyle(
                                  color: Colors.grey,
                                  fontSize: 15,
                                ),
