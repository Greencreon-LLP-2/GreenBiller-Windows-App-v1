          ...
          children: [
                ...
                children: [
                  _buildReportSectionDesktop("Sales Reports", [
                    _ReportItem("Sales Summary", Icons.summarize, () {
                      Get.toNamed(AppRoutes.salesSummary);
                    }),
                    _ReportItem("Sales by Item", Icons.inventory_2, () {
                      Get.toNamed(AppRoutes.salesSummaryByItem);
                    }),
                    _ReportItem("Sales by Customer", Icons.people, () {
                      Get.toNamed(AppRoutes.salesSummaryByCustomer);
                    }),
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildReportSectionDesktop("Purchase Reports", [
                    _ReportItem("Purchase Summary", Icons.summarize, () {
                      Get.toNamed(AppRoutes.purcahseSummary);
                    }),
                    _ReportItem("Purchase by Item", Icons.inventory_2, () {
                      Get.toNamed(AppRoutes.purcahseSummaryByItem);
                    }),
                    _ReportItem("Purchase by Supplier", Icons.people, () {
                      Get.toNamed(AppRoutes.purcahseSummaryByCustomer);
                    }),
                    // _ReportItem("Payment Made", Icons.payments, () {}),
                  ]),
      ...
      child: Column(
        ...
        children: [
          ...
          GridView.count(
            ...
            children: items
                .map((item) => _buildReportCardDesktop(item))
                .toList(),
          ),
        ],
      ),
