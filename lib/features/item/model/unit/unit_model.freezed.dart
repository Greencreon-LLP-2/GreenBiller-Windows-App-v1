...
mixin _$Datum {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, storeId, parentId, unitName,
      unitValue, description, status, createdAt, updatedAt);
...
abstract mixin class $DatumCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "unit_value") String? unitValue,
...
class _Datum implements Datum {
  const _Datum(
      ...
      @JsonKey(name: "unit_value") this.unitValue,
