...
mixin _$Datum {
  ...
  @JsonKey(name: "status")
  int? get status;
  @JsonKey(name: "inapp_view")
  String? get inappView;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.status, status) || other.status == status) &&
            (identical(other.inappView, inappView) ||
                other.inappView == inappView) &&
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      ...
      status: freezed == status
          ...
          : status // ignore: cast_nullable_to_non_nullable
              as int?,
      inappView: freezed == inappView
          ? _self.inappView
          : inappView // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _Datum implements Datum {
  const _Datum(
      ...
      @JsonKey(name: "status") this.status,
      @JsonKey(name: "inapp_view") this.inappView,
